...
{/* Button */}
		<div className="space-x-2">
			<button aria-label="Share this post" type="button" className="p-2 text-center border">
            <i className="fa-regular fa-pen-to-square"></i>
                <span> Edit</span>
			</button>


			<button onClick={()=>handleDelete(_id)} aria-label="Bookmark this post" type="button" className="p-2 border">
