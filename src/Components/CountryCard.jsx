...
const CountryCard = ({countryCard}) => {
	...
	<div className="flex justify-between pb-4 border-bottom">
		<div className="flex items-center">
			<a rel="noopener noreferrer" href="#" className="mb-0 capitalize dark:text-gray-800 font-bold">{spotName} <span className="ml-3"><i className="fa-solid fa-dollar-sign"></i> {cost}</span> </a>
		</div>
	...
	<div className="space-y-4">
		...
		<div className="space-y-2">
			<a rel="noopener noreferrer" href="#" className="block">
				<h3 className="text-xl font-semibold dark:text-violet-600">{countryName}</h3>
			</a>
