...
const Footer = () => {
    return (
        <div>
   <footer className="px-4 divide-y dark:bg-yellow-800 text-white">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full ">
					<img className="rounded-full" src="https://i.ibb.co/bPj7Szx/logo.jpg" alt="" />
				</div>
				<span className="self-center text-2xl font-semibold">Mount Ride Ltd.</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center font-bold">© 2023 mountride. All rights reserved.</div>
</footer>
        </div>
    );
};
